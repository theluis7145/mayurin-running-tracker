      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        <div className="max-h-64 sm:max-h-80 overflow-y-auto">
          {[...laps].reverse().map((lap) => (
            <div
              key={lap.lapNumber}
              className="flex items-center justify-between p-4 sm:p-3 border-b border-sky-100 last:border-b-0"
            >
              <div className="flex items-center gap-3 sm:gap-4">
                <div className="flex items-center justify-center w-10 h-10 sm:w-8 sm:h-8 bg-sky-100 rounded-full text-sky-700 font-semibold text-sm">
                  {lap.lapNumber}
                </div>
                <div>
                  <div className="text-base sm:text-sm font-medium text-gray-800">
